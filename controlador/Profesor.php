...
$conexion =new ProfesorModelo();
$conexion->verificar_sesion_profesor();//da error con el incio de sesion publico

class Profesor extends ProfesorModelo{
...
if(isset($_GET["peticion"])) $objeto =new Profesor();
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="2" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
$objeto->cerrar_sesion_control();
}
if(isset($_GET["peticion"]) && $_GET["peticion"]=="3" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_user"]) && $_GET["cod_user"]!="" ){
$objeto->datos_profesor_control($_GET["cod_user"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="4" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["clavea"]) && $_GET["clavea"]!="" && isset($_GET["claven"]) && $_GET["claven"]!="" && isset($_GET["clavern"]) && $_GET["clavern"]!=""){
$objeto->cambiar_clave_control($_GET["clavea"], $_GET["claven"], $_GET["clavern"], $_SESSION['clave_user'], $_SESSION['cod_user']);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="5" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_user"]) && $_GET["cod_user"]!="" ){
$objeto->datos_profesor_form_control($_GET["cod_user"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="6" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["tabla"]) && $_GET["tabla"]!="" && isset($_GET["campo"]) && $_GET["campo"]!="" && isset($_GET["valor"])){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="7" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["seccion"]) && $_GET["seccion"]!="" &&
   ...
   isset($_GET["correo"]) && $_GET["correo"]!="" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")))$objeto->insertar_est_control($_GET["seccion"], $_GET["nacionalidad"], $_GET["cedula"], $_GET["nombre1"],$_GET["nombre2"], $_GET["apellido1"],$_GET["apellido2"], $_GET["telefono1"], $_GET["telefono2"], $_GET["direccion"],$_GET["lugar"], $_GET["cargo"],$_GET["year"],$_GET["mes"], $_GET["dia"], $_GET["correo"]);
else echo "Elija una secci&oacute;n para ver sus Horarios.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="9" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="10"){
	if(isset($_GET["seccion"]) && $_GET["seccion"]!="" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cedula_est"]) && $_GET["cedula_est"]!="" && isset($_GET["deposito"]) && $_GET["deposito"]!="")$objeto->validar_inscripcion_control($_GET["seccion"], $_GET["cedula_est"], $_GET["deposito"]);
else echo "Debe elegir sección, cedula y deposito";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="11" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="12"){
	if(isset($_GET["seccion"]) && $_GET["seccion"]!="" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cedula_est"]) && $_GET["cedula_est"]!="")$objeto->invalidar_inscripcion_control($_GET["seccion"], $_GET["cedula_est"]);
else echo "Debe elegir sección y cedula.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="13" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="14" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cedula_est"]) && $_GET["cedula_est"]!="")$objeto->obtener_est_control($_GET["cedula_est"]);
else echo "Debe enviar una cédula.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="15" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="16" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="17" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cedula_est"]) && $_GET["cedula_est"]!="")$objeto->obtener_est_cuadro_control_para_form($_GET["cedula_est"]);
else echo "Ingrese cedula del estudiante para buscar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="18" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_user"]) && $_GET["cod_user"]!="" ){
$objeto->datos_est_form_control($_GET["cod_user"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="19" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="20" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="21" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cod_idioma"]) && $_GET["cod_idioma"]!="")$objeto->editar_idioma_form_control($_GET["cod_idioma"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="22" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["tabla"]) && $_GET["tabla"]!="" && isset($_GET["campo"]) && $_GET["campo"]!="" && isset($_GET["valor"]) && $_GET["valor"]!="" ){
...
if(isset($_GET["nacionalidad"]) && $_GET["nacionalidad"]!="" &&
   ...
   isset($_GET["telefono1"]) && $_GET["telefono1"]!="" &&
   isset($_GET["telefono2"]) &&
   isset($_GET["correo"]) && $_GET["correo"]!="" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")))$objeto->insertar_admin_control($_GET["nacionalidad"], $_GET["cedula"], $_GET["nombre1"],$_GET["nombre2"], $_GET["apellido1"],$_GET["apellido2"], $_GET["telefono1"], $_GET["telefono2"], $_GET["correo"]);
else echo "Falta campo por llenar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="24" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cedula_admin"]) && $_GET["cedula_admin"]!="")$objeto->obtener_admin_cuadro_control_para_form($_GET["cedula_admin"]);
else echo "Ingrese cedula del estudiante para buscar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="25" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_user"]) && $_GET["cod_user"]!="" ){
$objeto->datos_admin_form_otros_control($_GET["cod_user"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="26" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cedula_admin"]) && $_GET["cedula_admin"]!="")$objeto->obtener_admin_cuadro_control_para_form($_GET["cedula_admin"]);
else echo "Ingrese cedula del estudiante para buscar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="27" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cedula_admin"]) && $_GET["cedula_admin"]!="")$objeto->obtener_admin_cuadro_control($_GET["cedula_admin"]);
else echo "Ingrese cedula del estudiante para buscar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="28" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["nacionalidad"]) && $_GET["nacionalidad"]!="" &&
   ...
   isset($_GET["telefono1"]) && $_GET["telefono1"]!="" &&
   isset($_GET["telefono2"]) &&
   isset($_GET["correo"]) && $_GET["correo"]!="" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")))$objeto->insertar_profesor_control($_GET["nacionalidad"], $_GET["cedula"], $_GET["nombre1"],$_GET["nombre2"], $_GET["apellido1"],$_GET["apellido2"], $_GET["telefono1"], $_GET["telefono2"], $_GET["correo"]);
else echo "Falta campo por llenar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="30" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cedula_profesor"]) && $_GET["cedula_profesor"]!="")$objeto->obtener_profesor_cuadro_control_para_form($_GET["cedula_profesor"]);
else echo "Ingrese cedula del estudiante para buscar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="31" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_user"]) && $_GET["cod_user"]!="" ){
$objeto->datos_profesor_form_otros_control($_GET["cod_user"]);
}


if(isset($_GET["peticion"]) && $_GET["peticion"]=="32" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["cedula_profesor"]) && $_GET["cedula_profesor"]!="")$objeto->obtener_profesor_cuadro_control($_GET["cedula_profesor"]);
else echo "Ingrese cedula del estudiante para buscar.";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="33" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_user"]) && $_GET["cod_user"]!="" ){
$objeto->obtener_profesor_control($_GET["cod_user"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="34" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_seccion"]) && $_GET["cod_seccion"]!="" && isset($_GET["cod_idioma"]) && $_GET["cod_idioma"]!="" && isset($_GET["nivel"]) && $_GET["nivel"]!="" && isset($_GET["maximo_de_est"]) && $_GET["maximo_de_est"]!="" && isset($_GET["cod_profesor"]) && $_GET["cod_profesor"]!=""){
$objeto->registrar_seccion_control($_GET["cod_seccion"], $_GET["cod_idioma"], $_GET["nivel"], $_GET["maximo_de_est"], $_GET["cod_profesor"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="35" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_seccion"]) && $_GET["cod_seccion"]!=""){
$objeto->obtener_seccion_form_control($_GET["cod_seccion"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="36" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["tabla"]) && $_GET["tabla"]!="" && isset($_GET["campo"]) && $_GET["campo"]!="" && isset($_GET["valor"]) && $_GET["valor"]!="" ){
if(isset($_GET["cod_seccion"]))$objeto->editar_datos_admin_control($_GET["campo"],$_GET["valor"],$_GET["cod_seccion"],$_GET["tabla"]);

}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="37" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="38" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_seccion"]) && $_GET["cod_seccion"]!=""){
$objeto->obtener_horario_seccion_control($_GET["cod_seccion"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="39" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
...
if(isset($_GET["peticion"]) && $_GET["peticion"]=="40"){
	if(((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_inscripcion"]) && $_GET["cod_inscripcion"]!="" && isset($_GET["deposito"]) && $_GET["deposito"]!="")$objeto->validar_inscripcion_directo_control($_GET["cod_inscripcion"], $_GET["deposito"]);
else echo "Debe elegir sección, cedula y deposito";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="41" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r"))){
if(isset($_GET["seccion"]) && $_GET["seccion"]!="")$objeto->obtener_seccion_cuadro_nota_control($_GET["seccion"], $_SESSION["cod_profesor"]);
else echo "Elija una secci&oacute;n para buscar.";
}


if(isset($_GET["peticion"]) && $_GET["peticion"]=="42" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["tabla"]) && $_GET["tabla"]!="" && isset($_GET["campo"]) && $_GET["campo"]!="" && isset($_GET["valor"]) && isset($_GET["cod_inscripcion"]) && $_GET["cod_inscripcion"]!=""){
	
	if(is_numeric($_GET["valor"]))$objeto->editar_datos_admin_control($_GET["campo"],$_GET["valor"],$_GET["cod_inscripcion"],$_GET["tabla"]);
	if($_GET["valor"]=="")$objeto->editar_datos_admin_control($_GET["campo"],$_GET["valor"],$_GET["cod_inscripcion"],$_GET["tabla"]);
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="43" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["tabla"]) && $_GET["tabla"]!="" && isset($_GET["campo"]) && $_GET["campo"]!="" && isset($_GET["valor"])){
	
	$objeto->editar_datos_admin_control($_GET["campo"],$_GET["valor"],"nota_en_grupo",$_GET["tabla"]);
	
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="44"){
	if(((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_inscripcion"]) && $_GET["cod_inscripcion"]!="")$objeto->obtener_inscripcion_form_control($_GET["cod_inscripcion"]);
else echo "Consultar Estudiante";
}

if(isset($_GET["peticion"]) && $_GET["peticion"]=="45" && ((isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="p") || (isset($_SESSION["tipo_user"]) && $_SESSION["tipo_user"]=="r")) && isset($_GET["cod_user"]) && $_GET["cod_user"]!="" && isset($_GET["valor"])){
