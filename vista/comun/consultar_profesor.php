...
<input name="cedula_profesor" id="cedula_profesor" placeholder="Numeros Enteros." pattern="[0-9]{0,8}" required  maxlength="8" style="text-align:center" onkeyup="MostrarConsulta('../../controlador/Administrador.php?peticion=32&cedula_profesor='+document.getElementById('cedula_profesor').value);"><br><br>
