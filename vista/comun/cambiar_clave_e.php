<?php if (!isset($_SESSION['est'])) session_start(); if (isset($_SESSION['est'])){ ?>
<form style="width: 801px;" method="post" onSubmit="MostrarConsulta('../../controlador/Estudiante.php?peticion=4'+'&clavea='+document.getElementById('antigua').value+'&claven='+document.getElementById('nueva').value+'&clavern='+document.getElementById('renueva').value); return false">
