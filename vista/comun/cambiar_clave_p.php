...
<form style="width: 801px;" method="post" onSubmit="MostrarConsulta('../../controlador/Profesor.php?peticion=4'+'&clavea='+document.getElementById('antigua').value+'&claven='+document.getElementById('nueva').value+'&clavern='+document.getElementById('renueva').value); return false">
