...
<input name="cedula_est" id="cedula_est" placeholder="Numeros Enteros." pattern="[0-9]{0,8}" required  maxlength="8" style="text-align:center" onkeyup="MostrarConsulta('../../controlador/Administrador.php?peticion=16&cedula_est='+document.getElementById('cedula_est').value);"><br><br>
