...
<table width="1124" class="" border="0">
  ...
  <?php
  		$sql="select * from inscripcion where cod_seccion='".$datos_seccion['cod_seccion']."' and activo='a' and estado='v'";
		$resultado_ins=pg_query($sql);
		$con=0;
		$i=0;
		$sql="select count(*) from inscripcion where cod_seccion='".$datos_seccion['cod_seccion']."' and activo='a' and estado='v'";
