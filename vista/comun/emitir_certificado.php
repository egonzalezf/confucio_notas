...
<tbody>
<tr align="center">
    <!--<td colspan="2" rowspan="1" style="vertical-align: top; width: 425px;"><h2>Avanzar secci&oacute;n 1er nivel</h2></td>-->
    <td colspan="2" rowspan="1" style="vertical-align: top; width: 425px;"><h2>Emitir Certificados</h2>    
    </td>
</tr>
...
<!--<select name="seccion" id="seccion" required x-moz-errormessage="Seleccione una opción" style="width:250px" 
        onchange="MostrarConsulta('../../controlador/Administrador.php?peticion=13&seccion='+document.getElementById('seccion').value+'&estado='+document.getElementById('a').value);">
