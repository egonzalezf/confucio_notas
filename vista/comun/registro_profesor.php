...
<form method="post" name="est" onSubmit="MostrarConsulta('../../controlador/Administrador.php?peticion=29'+'&nacionalidad='+document.getElementById('nacionalidad').value+'&cedula='+document.getElementById('cedula').value+'&nombre1='+document.getElementById('nombre1').value+'&nombre2='+document.getElementById('nombre2').value+'&apellido1='+document.getElementById('apellido1').value+'&apellido2='+document.getElementById('apellido2').value+'&telefono1='+document.getElementById('telefono1').value+'&telefono2='+document.getElementById('telefono2').value+'&correo='+document.getElementById('correo').value); return false">
...
style="vertical-align(*): top; width(*): 425px;"><h2>Registrar Profesor</h2>
</td>
</tr>
<tr align="center">
<td colspan="2" rowspan="1"
