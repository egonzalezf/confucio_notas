...
style="vertical-align: top; width: 425px;"><h2>Editar idioma</h2>
</td>
</tr>
...
<input type="submit" name="Enviar" value="Enviar" onclick="MostrarConsulta('../../controlador/Administrador.php?peticion=21'+'&cod_idioma='+document.getElementById('cod_idioma').value); return false"
