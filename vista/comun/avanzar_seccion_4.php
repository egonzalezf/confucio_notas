...
style="vertical-align: top; width: 425px;"><h2>Avanzar secci&oacute;n 4to nivel</h2>
</td>
</tr>
<td style="vertical-align: top; text-align: center;">Sección:

<select name="seccion" id="seccion" required x-moz-errormessage="Seleccione una opción" style="width:100px" onchange="MostrarConsulta('../../controlador/Administrador.php?peticion=41&seccion='+document.getElementById('seccion').value);">
