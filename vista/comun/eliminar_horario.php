...
style="vertical-align: top; width: 425px;"><h2>Eliminar horario</h2>
</td>
</tr>
<td style="vertical-align: top; text-align: center;">Sección:

<select name="cod_seccion" id="cod_seccion" required x-moz-errormessage="Seleccione una opción" style="width:100px">
...
<br /><br />
<input type="submit" onclick="MostrarConsulta('../../controlador/Administrador.php?peticion=38&cod_seccion='+document.getElementById('cod_seccion').value);" value="Consultar" />
</td>
</tr>
</tbody>
</table>
