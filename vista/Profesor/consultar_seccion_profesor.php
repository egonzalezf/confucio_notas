						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<article class="first">
									...
									<p>
                                   		<div id="resultado2" style="margin-left:8%;"></div>
                                      
                                    </p>
                                   <a  id="enlace" style="visibility:hidden;margin-left:25%;" href="#" onClick="MostrarConsulta('../comun/consultar_seccion_p.php');">VOLVER</a>
