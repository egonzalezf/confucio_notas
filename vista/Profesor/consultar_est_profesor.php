...
if(isset($_SESSION['prof'])){
	?>
	<body onLoad="MostrarConsulta('../comun/consultar_est_p.php');">
						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<center>
                                    ...
                                    <a  id="enlace" style="visibility:hidden;margin-right:22%;" href="#" onClick="MostrarConsulta('../comun/consultar_est_p.php');">VOLVER</a>
								</center>
								</article>							
