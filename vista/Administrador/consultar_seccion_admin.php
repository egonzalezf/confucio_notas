...
if(isset($_SESSION['admin'])){
	 ?>
	<body onLoad="MostrarConsulta('../comun/consultar_seccion.php');">
						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<article class="first">
									...
									<p>
                                   		<div id="resultado2" style="margin-left:5%;"></div>
                                    </p>
                                    <a  id="enlace" style="visibility:hidden;margin-left:30%;"  href="#" onClick="MostrarConsulta('../comun/consultar_seccion.php');">VOLVER</a>
   
								</article>	
                                 
	 <a  id="enlace" style="visibility:hidden;margin-right:22%;"  href="#" onClick="MostrarConsulta('../comun/consultar_seccion.php');">VOLVER</a>
