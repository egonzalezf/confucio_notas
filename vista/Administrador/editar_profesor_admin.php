...
if(isset($_SESSION['admin'])){
	?>
	<body onLoad="MostrarConsulta('../comun/editar_profesor.php');">
						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<center>
                                    ...
                                    <a  id="enlace" style="visibility:hidden;margin-right:22%;" href="#" onClick="MostrarConsulta('../comun/editar_profesor.php');">VOLVER</a>
								</center>
								</article>							
