...
if(isset($_SESSION['admin'])){?>
	<body onLoad="MostrarConsulta('../comun/editar_idioma.php');">
...
<center>
									<p>
                                   		<div id="resultado2" style="margin-left:-25%;"></div>
                                        
                                        <a  id="enlace" style="visibility:hidden;margin-left:-25%;" href="#" onClick="MostrarConsulta('../comun/editar_idioma.php');">VOLVER</a>
                                    </p>
