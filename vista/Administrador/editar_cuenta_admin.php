...
if(isset($_SESSION['admin'])){?>
	<body onLoad="MostrarConsulta('../../controlador/Administrador.php?peticion=5&cod_user=<?php echo $_SESSION['cod_user']; ?>');">
						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<center>
                                    ...
                                    <a  id="enlace" style="visibility:hidden;margin-right:22%;" href="#" onClick="MostrarConsulta('../../controlador/Administrador.php?peticion=5&cod_user=<?php echo $_SESSION['cod_user']; ?>');">VOLVER</a>
								</center>
								</article>							
