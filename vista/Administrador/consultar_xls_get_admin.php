...
<TR>
<TD colspan="3" style="background:#399;color:#fff;font-weight:bold;">Instituto Confucio de la Universisdad Bolivariana de Venezuela</TD>
...
<TD style="background:#399;color:#fff;font-weight:bold;">Deposito</TD>
<TD style="background:#399;color:#fff;font-weight:bold;">Fecha</TD>
</TR>
<?php

$resultado1=pg_query("SELECT * from inscripcion where cod_seccion='".$_GET['seccion']."' and estado='".$_GET['estado']."' and activo='a'");
if($resultado1 === FALSE) {
...
<TD>";
if($datos1['deposito']!="")echo "N: ".$datos1['deposito'];
else echo "N: sin deposito.";
echo "</TD>
<TD>".$datos1['fecha']."</TD>
</TR>";
}
