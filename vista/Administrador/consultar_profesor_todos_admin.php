...
if(isset($_SESSION['admin'])){
	?>
	<body onLoad="MostrarConsulta('../comun/consultar_profesor_todos.php');">
              ...
              <div class="row">
						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<center>
                                	<p>
                                   		<div  style="margin-left:-15%;" id="resultado2"></div>
                                    </p>
                                    
                                    <a  id="enlace" style="visibility:hidden;margin-right:22%;" href="#" onClick="MostrarConsulta('../comun/consultar_profesor_todos.php');">VOLVER</a>
								</center>
								</article>							
