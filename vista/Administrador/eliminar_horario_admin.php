...
if(isset($_SESSION['admin'])){
	?>
	<body onLoad="MostrarConsulta('../comun/eliminar_horario.php');">
						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<article class="first">
									...
									<center>
									<p>
                                   		<div id="resultado2" style="margin-left:-24%;"></div>
                                        
                                    </p>
                                    
                                      <a  id="enlace" style="visibility:hidden;margin-right:22%;" href="#" onClick="MostrarConsulta('../comun/editar_seccion.php');">VOLVER</a>
