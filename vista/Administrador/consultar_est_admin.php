...
if(isset($_SESSION['admin'])){
	?>
	<body onLoad="MostrarConsulta('../comun/consultar_est.php');">
              ...
              <div class="row">
						...
						<div class="9u skel-cell-mainContent">
							...
							<!-- Content -->
								...
								<center>
                                	<p>
                                   		<div  style="margin-right:25%;" id="resultado2"></div>
                                    </p>
                                    
                                    <a  id="enlace" style="visibility:hidden;margin-right:22%;" href="#" onClick="MostrarConsulta('../comun/consultar_est.php');">VOLVER</a>
								</center>
								</article>							
