...
if(isset($_SESSION['admin'])){
	 ?>
	<body onLoad="MostrarConsulta('../comun/avanzar_seccion_4.php');">
...
<center>
                                    ...
                                    <a  id="enlace" style="visibility:hidden;margin-left:-2%;" href="#" onClick="MostrarConsulta('../comun/avanzar_seccion_4.php');">VOLVER</a>
