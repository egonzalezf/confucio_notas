...
class ProfesorModelo extends ClaseMaestra{
	...
	function datos_profesor($cod_user){
		...
		if(parent::conectar()){
			...
			$salida.="<tr>";
			$salida.="<td colspan='2'>";
			$salida.="<h3>Datos de Profesor</h3>";
			$salida.="</td>";
			$salida.="</tr>";
	...
	function datos_profesor_form($cod_user){
		...
		if(parent::conectar()){
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nacionalidad&cod_user=".$datos['cod_user']."&tabla=profesor&valor='+document.getElementById('nacionalidad').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=cedula_prof&tabla=profesor&valor='+document.getElementById('cedula').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nombre1&tabla=profesor&valor='+document.getElementById('nombre1').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nombre2&tabla=profesor&valor='+document.getElementById('nombre2').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=apellido1&tabla=profesor&valor='+document.getElementById('apellido1').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=apellido2&tabla=profesor&valor='+document.getElementById('apellido2').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=telefono1&tabla=profesor&valor='+document.getElementById('telefono1').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=telefono2&tabla=profesor&valor='+document.getElementById('telefono2').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=correo&tabla=usuario&valor='+document.getElementById('correo').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="<tr>";
				...
				$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nacionalidad&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('nacionalidad').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=cedula_prof&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('cedula').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nombre1&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('nombre1').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nombre2&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('nombre2').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=apellido1&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('apellido1').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=apellido2&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('apellido2').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=telefono1&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('telefono1').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=telefono2&cod_user=".$datos1['cod_user']."&tabla=profesor&valor='+document.getElementById('telefono2').value".");"."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=correo&cod_user=".$datos1['cod_user']."&tabla=usuario&valor='+document.getElementById('correo').value".");multiconsultas();".'"'.">Guardar Todo</button>";
...
echo '<br>
		...
		if($ban==1)echo'<a href="consultar_xls_get_admin.php?seccion='.$seccion.'">Descargar xls</a> / <a href="../comun/planilla_profesor.php?seccion='.$seccion.'" target="_blank">Descargar planilla de asistencias</a>';
		////////////	
...
style="font-weight: bold; font-style: italic;">No existen registros para esta sección</span><br>
	    ...
	    $resultado=pg_query($sql);
		if($datos=pg_fetch_array($resultado)){
			echo'<table class="table-respuesta datos margen25" border="1"
cellpadding="2" cellspacing="2">
<tbody>
<tr align="center">
...
<td style="vertical-align: top; width: 227px;text-align: center;"><a href="#"'."onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=18&cod_user=".$datos['cod_user']."'".')">'.strtoupper($datos['nacionalidad']).''.$datos['cedula_est'].'</a><br>
</td>
</tr>
<tr>
<td
...
function obtener_est_cuadro_para_form($cedula_est){
		...
		echo '<table class="table-respuesta margen25-1280 margen25-1024 margen25 Busqueda de Estudiante"><tbody>
...
function datos_est_form($cod_user){
		...
		if(parent::conectar()){
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nacionalidad&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('nacionalidad').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=cedula_est&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('cedula').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nombre1&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('nombre1').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nombre2&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('nombre2').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=apellido1&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('apellido1').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=apellido2&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('apellido2').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=telefono1&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('telefono1').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=telefono2&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('telefono2').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=direccion&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('direccion').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=cargo&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('cargo').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
...
<input type="text" maxlength="4" size="4" name="year" value="'.substr($datos['fecha'], 0, 4).'" id="year" placeholder="año" required>';
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=fecha&cod_user=".$datos['cod_user']."&tabla=estudiante&valor='+document.getElementById('year').value+'-'+document.getElementById('mes').value+'-'+document.getElementById('dia').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=correo&cod_user=".$datos['cod_user']."&tabla=usuario&valor='+document.getElementById('correo').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td style='vertical-align: top; width:250px;border-top:2px solid #ccc;text-align: center;'>";
			$salida.='<button '."onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=44&cod_inscripcion=".$datos_inscripcion['cod_inscripcion']."'".')">Editar</button>';
			$salida.="</td>";
			$salida.="</tr>";
			}
...
$salida.="</select>";
			...
			$salida.="<td>";
			$salida.='<input
maxlength="2" name="maximo_de_est" id="maximo_de_est" value="'.$datos['maximo_de_est'].'" placeholder="Numeros Enteros." pattern="[0-9]{0,8}" required>';
			$salida.="</td>";
			$salida.="<td>";
...
echo '<input type="text" maxlength="2" size="2" max="20" min="0" value="'.$datos3['nota'].'" name="'.$count.'" id="'.$count.'">';
echo '<input type="text" value="'.$datos3['cod_inscripcion'].'" name="i'.$count.'" id="i'.$count.'" hidden="hidden">';
...
$count++;
		...
		echo '<input type="text" value="'.$count.'" name="total" id="total" hidden="hidden">';
		...
		echo '<tr align="center">
<td colspan="6" rowspan="1" style="vertical-align: top; background-color: rgb(102, 204, 204);">
<input type="submit" value="Guardar Todo" '."onclick=".'"'."EnviarConsultaNotas(document.getElementById('total').value".");".'"'.'>
<br></td>
</tr>';
...
function editar_nota($campo, $valor, $cod, $tabla){
	...
	if(parent::conectar()){
			...
			$salida="<table border='1' id='Consultar Estudiante'>";
			
			$salida.="<tr>";
			$salida.="<td colspan='2'>";
			$salida.="<h3>Editar la inscripci&oacute;n</h3>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=45&campo=deposito&cod_user=".$datos['cod_inscripcion']."&tabla=inscripcion&valor='+document.getElementById('deposito').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=nota&cod_user=".$datos['cod_inscripcion']."&tabla=inscripcion&valor='+document.getElementById('nota').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=activo&cod_user=".$datos['cod_inscripcion']."&tabla=inscripcion&valor='+document.getElementById('activo').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
			...
			$salida.="</td>";
			$salida.="<td>";
			$salida.="<button onclick=".'"'."MostrarConsulta('../../controlador/Profesor.php?peticion=6&campo=cod_seccion&cod_user=".$cod_inscripcion."&tabla=inscripcion&valor='+document.getElementById('seccion').value".");".'"'.">Cambiar</button>";
			$salida.="</td>";
			$salida.="</tr>";
